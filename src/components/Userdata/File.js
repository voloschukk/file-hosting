            ...
            <>
                {this.props.view === "tiles" &&
                    <div className="tiles-main-container">
                        <input class="tiles-form-check" type="checkbox" id={file.id} onChange={this.checkFile}/>
                ...
                {this.props.view === "details" &&
                    <div className="details-main-container">
                        <input class="details-form-check" type="checkbox" id={file.id} onChange={this.checkFile}/>
                        {this.state.renameFileId.toString() !== file.id.toString() &&
